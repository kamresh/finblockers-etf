package com.cts.hackathon.finblockers.plugin;

import com.cts.hackathon.finblockers.api.ETFApi;
...
public class ETFCreationPlugin implements WebServerPluginRegistry {
    /**
     * A list of classes that expose web APIs.
     */
    private final List<Function<CordaRPCOps, ?>> webApis = ImmutableList.of(ETFApi::new);

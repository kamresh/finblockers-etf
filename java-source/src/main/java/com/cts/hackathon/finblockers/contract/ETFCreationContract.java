 ...
 *
 * This contract enforces rules regarding the creation of a valid [ETFCreationState], which in turn encapsulates an [IOU].
 *
 ...
 */
public class ETFCreationContract implements Contract {
    public static final String ETF_CONTRACT_ID = "com.cts.hackathon.finblockers.contract.ETFCreationContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            final ETFCreationState out = tx.outputsOfType(ETFCreationState.class).get(0);

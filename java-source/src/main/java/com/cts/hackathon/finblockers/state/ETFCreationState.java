package com.cts.hackathon.finblockers.state;

import com.cts.hackathon.finblockers.schema.IOUSchemaV1;
 ...
 */
public class ETFCreationState implements LinearState, QueryableState {
     ...
     */
    public ETFCreationState(Integer value,
                            Party lender,
                            Party borrower)
    {
        this.value = value;

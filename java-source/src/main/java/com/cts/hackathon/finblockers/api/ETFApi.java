package com.cts.hackathon.finblockers.api;

import com.cts.hackathon.finblockers.flow.ETFCreationFlow;
...
public class ETFApi {
    ...
    @Path("ious")
    @Produces(MediaType.APPLICATION_JSON)
    public List<StateAndRef<ETFCreationState>> getIOUs() {
        return rpcOps.vaultQuery(ETFCreationState.class).getStates();
    }
    ...
    public Response createIOU(@QueryParam("iouValue") int iouValue, @QueryParam("partyName") CordaX500Name partyName) throws InterruptedException, ExecutionException {
        ...
        try {
            FlowProgressHandle<SignedTransaction> flowHandle = rpcOps
                    .startTrackedFlowDynamic(ETFCreationFlow.Initiator.class, iouValue, otherParty);
